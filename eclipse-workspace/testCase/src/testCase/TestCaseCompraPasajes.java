...
public class TestCaseCompraPasajes {
	 ...
	 private WebDriver driver;
	  ...
	  public void setUp() throws Exception {
		 System.setProperty("webdriver.gecko.driver", "C:\\Users\\bianc\\eclipse-workspace\\geckodriver.exe");
	  ...
	  public void testCaseCompraPasajes() throws Exception {
	    ...
	    driver.findElement(By.name("passFirst0")).sendKeys("Jose");
	    ...
	    driver.findElement(By.name("creditnumber")).sendKeys("123456778");
